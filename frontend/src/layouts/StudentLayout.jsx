...
import { LayoutDashboard, LogOut, Wallet, FileText, Settings, Bell, Archive } from 'lucide-react';
...
export default function StudentLayout() {
    ...
    const navItems = [
        ...
        { name: 'Fee Menu', path: '/student/fees', icon: Wallet },
        { name: 'Payment History', path: '/student/history', icon: FileText },
        { name: 'Requests', path: '/student/requests', icon: Archive },
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
                ...
                <header style={{
                    ...
                    <div style={{ position: 'relative', width: '320px' }}>
                        ...
                        <input
                            type="text"
                            placeholder="Search for fees, payments..."
                            style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                        <button style={{ background: 'none', border: 'none', cursor: 'pointer', padding: '8px', borderRadius: '10px', color: '#6b7280' }}>
                            <Bell size={20} />
                        </button>
                            ...
                            {showProfileDropdown && (
                                <div style={{
                                    ...
                                    <div style={{ paddingBottom: '12px', borderBottom: '1px solid #f3f4f6', marginBottom: '8px' }}>
                                        <p style={{ fontSize: '11px', color: '#9ca3af', textTransform: 'uppercase', letterSpacing: '0.05em', margin: '0 0 4px' }}>Personal Info</p>
                                    ...
                                    <div style={{ paddingBottom: '12px' }}>
                                        <p style={{ fontSize: '11px', color: '#9ca3af', textTransform: 'uppercase', letterSpacing: '0.05em', margin: '0 0 4px' }}>Academic Info</p>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                            <span style={{ fontSize: '12px', color: '#6b7280' }}>Roll Number</span>
                                            <span style={{ fontSize: '12px', fontWeight: 600, color: '#111827' }}>{user?.rollNumber || 'N/A'}</span>
                                        </div>
                                    </div>
                                    <button 
                                        onClick={logout}
